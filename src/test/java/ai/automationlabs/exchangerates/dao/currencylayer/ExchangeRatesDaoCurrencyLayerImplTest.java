...
import ai.automationlabs.exchangerates.dao.currencylayer.ExchangeRatesDaoCurrencyLayerImpl;
...
public class ExchangeRatesDaoCurrencyLayerImplTest {
	...
	@Mock
	ai.automationlabs.exchangerates.domain.currencylayer.BaseResponse.Error errorMock;
